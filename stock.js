...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    let allStocks = FALLBACK_STOCK_DATA;
    try {
        ...
        console.log('Using embedded fallback stock data.');
    }

    const stock = allStocks.find(s => s.ticker.toUpperCase() === ticker);

    if (!stock) {
        document.body.innerHTML = '<div class="container" style="color:#fff; padding:40px;"><h2>Stock not found. <a href="index.html" style="color:#06b6d4;">Return home</a></h2></div>';
        return;
    }
